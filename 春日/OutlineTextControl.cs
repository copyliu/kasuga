...
namespace 春日
{
	public class OutlineTextControl : FrameworkElement
	{
		...
		static OutlineTextControl()
		{
			...
			OutlineTextControl.OutlineMiterLimitProperty = DependencyProperty.Register("OutlineMiterLimit", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)0, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			...
			OutlineTextControl.ShadowDepthProperty = DependencyProperty.Register("ShadowDepth", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)0, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			...
			OutlineTextControl.ScaleXProperty = DependencyProperty.Register("ScaleX", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)1, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			OutlineTextControl.ScaleYProperty = DependencyProperty.Register("ScaleY", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)1, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			OutlineTextControl.CenterXProperty = DependencyProperty.Register("CenterX", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)0, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			OutlineTextControl.CenterYProperty = DependencyProperty.Register("CenterY", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)0, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			OutlineTextControl.AngleProperty = DependencyProperty.Register("Angle", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)0, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			...
			OutlineTextControl.FontSizeProperty = DependencyProperty.Register("FontSize", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)48, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
			...
			OutlineTextControl.StrokeThicknessProperty = DependencyProperty.Register("StrokeThickness", typeof(double), typeof(OutlineTextControl), new FrameworkPropertyMetadata((object)0, FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OutlineTextControl.OnOutlineTextInvalidated), null));
